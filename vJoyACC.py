...
# Разное
	...
	cursorHideCorner = 3						# [1..4] угол экрана, в котором прятать курсор мыши: 1 - верхн.лев., 2 - верхн.прав., 3 - нижн.лев., 4 - нижн.прав.
	...
	sysExecInterval = 5							# [1..10] делитель для системного таймера 1кГц. Частное двух чисел - частота выполнения скрипта; чем она выше, тем меньше задержка ввода, но выше нагрузка на комп 
	diagWatch = True							# [True;False] вывод в Watch
# Руль
	steerSensitivity = 50						# [1..100] чувствительность руля в нейтральном положении
	steerNonlinearity = 0						# [0..900] на сколько % чувствительность руля в крайних положениях выше, чем в нейтральном
# Педали и ручник
	mouseThrottleBrake = False					# [True;False] газ и тормоз кнопками мыши
	throttlePushRate = 50						# [1..100] скорость нажатия газа
	throttleReleaseRate = 50					# [1..100] скорость отпускания газа
	brakePushRate = 50							# [1..100] скорость нажатия тормоза
	brakeReleaseRate = 50						# [1..100] скорость отпускания тормоза
	clutchPushRate = 50							# [1..100] скорость нажатия сцепления
	clutchReleaseRate = 50						# [1..100] скорость отпускания сцепления
...
# Регулировка газа (увеличение/уменьшение максимальной глубины нажатия педали колесиком мыши и/или клавишами клавиатуры)
	throttleAdjust1Enabled = False				# [True;False] включить регулировку газа
	mouseWheelThrottleAdjust = False			# [True;False] регулировать колесиком мыши
...
# Регулировка газа альтернативная (уменьшение максимальной глубины нажатия педали при удержании клавиш-модификаторов)
	...
	throttleLimit1 = 25							# [0..100] максимальная глубина нажатия газа при удержании клавиши keyThrottleLimit1
	throttleLimit2 = 50							# [0..100] максимальная глубина нажатия газа при удержании клавиши keyThrottleLimit2
	throttleLimit3 = 75							# [0..100] максимальная глубина нажатия газа при удержании клавиши keyThrottleLimit3
# Регулировка тормоза (увеличение/уменьшение максимальной глубины нажатия педали колесиком мыши и/или клавишами клавиатуры)
	brakeAdjust1Enabled = False					# [True;False] включить регулировку тормоза
...
# Регулировка тормоза альтернативная (уменьшение максимальной глубины нажатия педали при удержании клавиш-модификаторов)
	...
	brakeLimit1 = 25							# [0..100] максимальная глубина нажатия тормоза при удержании клавиши keyBrakeLimit1
	brakeLimit2 = 50							# [0..100] максимальная глубина нажатия тормоза при удержании клавиши keyBrakeLimit2
	brakeLimit3 = 75							# [0..100] максимальная глубина нажатия тормоза при удержании клавиши keyBrakeLimit3
...
# "=Key.A" назначает клавишу "A", "=None" не назначает никакую клавишу (заглушка)
	keySwitch1st = Key.CapsLock # Key.RightControl	# обработка ввода: вкл/выкл (первая из сочетания клавиш)
	keySwitch2nd = None # Key.M					# обработка ввода: вкл/выкл (вторая клавиша из сочетания. Чтобы использовать только первую клавишу, поставьте "=None")
	keyThrottle = Key.A							# газ (ЛКМ, если mouseThrottleBrake = True)
	keyBrake = Key.Z							# тормоз (ПКМ, если mouseThrottleBrake = True)
	keyClutch = Key.C							# сцепление
	...
	keyBrakeAdjustUp = None						# регулировка тормоза: увеличить глубину нажатия педали
	keyBrakeAdjustDown = None					# регулировка тормоза: уменьшить глубину нажатия педали
	...
	keyTcPowerUp = None							# ПБС: увеличить силу
	keyTcPowerDown = None						# ПБС: уменьшить силу
	keyAbsPowerUp = None						# АБС: увеличить силу
	keyAbsPowerDown = None						# АБС: уменьшить силу
