...
# Разное
	...
	cursorHide = True							# [True;False] прятать курсор мыши
...
# Руль
	steerSensitivity = 25						# [1..100] чувствительность руля в нейтральном положении
	steerNonlinearity = 250						# [0..900] на сколько % чувствительность руля в крайних положениях выше, чем в нейтральном
# Педали и ручник
...
# Регулировка газа альтернативная (уменьшение максимальной глубины нажатия педали при удержании клавиш-модификаторов)
	...
	throttleLimit3 = 0							# [0..100] максимальная глубина нажатия газа при удержании клавиши keyThrottleLimit3
# Регулировка тормоза альтернативная (уменьшение максимальной глубины нажатия педали при удержании клавиш-модификаторов)
	...
	brakeLimit3 = 0								# [0..100] максимальная глубина нажатия тормоза при удержании клавиши keyBrakeLimit3	
...
# "=Key.A" назначает клавишу "A", "=None" не назначает никакую клавишу (заглушка)
	...
	keySwitch1st = Key.CapsLock					# обработка ввода: вкл/выкл (первая из сочетания клавиш)
	...
	keyThrottleLimit1 = Key.LeftShift			# регулировка газа альтернативная: уменьшить максимальную глубину нажатия педали до throttleLimit1 (при удержании)
	keyThrottleLimit2 = Key.LeftControl			# регулировка газа альтернативная: уменьшить максимальную глубину нажатия педали до throttleLimit2 (при удержании)
	...
	keyBrakeLimit1 = Key.LeftShift				# регулировка тормоза альтернативная: уменьшить максимальную глубину нажатия педали до brakeLimit1 (при удержании)
...
# Тормоз
	...
	brakeAxis = pedalHandler(brakeAxis, brakePressed, brakePushRate, brakeReleaseRate, keyRateMult, brakeAdjustMin, brakeMax)
