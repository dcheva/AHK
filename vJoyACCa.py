...
if enabled:
	...
	#accG 	v1 = float(''.join(map(str, unpack('f', acPhysics[28:32]))))
	#accG 	v2 = float(''.join(map(str, unpack('f', acPhysics[36:40]))))
	#accG 	v3 = float(''.join(map(str, unpack('f', acPhysics[40:44]))))
	#accG 	g1 = float(''.join(map(str, unpack('f', acPhysics[44:48]))))
	#accG 	g2 = float(''.join(map(str, unpack('f', acPhysics[48:52]))))
	#accG 	g3 = float(''.join(map(str, unpack('f', acPhysics[52:56]))))
